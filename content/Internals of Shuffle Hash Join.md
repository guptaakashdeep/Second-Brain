...
2. **Partition Key Extraction:** For each row, Spark extracts the join key and computes a partition ID using [[HashPartitioning in Apache Spark|HashPartitioning]]
